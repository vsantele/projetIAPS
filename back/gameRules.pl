...
regle_rep(ordre, 3,
    ...
    [['L\'ordre', des, coureurs, accidentes, est, le, 'suivant :', du, coureur, qui, a, provoque, la, chute, 
    au, coureur, qui, a, rejoint, plus, tard, le, lieu, de, 'l\'accident.']]).
% ---------------------------------------------------------------- %
regle_rep(equipes, 1,
...
regle_rep(etapes, 2,
    ...
    [['Il', y, a, X, 'etapes,', une, etape, de, montagne, et, une, etape, de, 'plaine.']]) :- nb_etapes(X).
% ---------------------------------------------------------------- %
regle_rep(seconde, 1,
...
regle_rep(cases, 1,
    ...
    les, 'autres. Il', faut, savoir, 'qu\'il', y, a, une, sous, priorite, dans, les, virages, en, suivant, 'l\'ordre',
...
regle_rep(aspiration, 1,
    ...
    [['Il s\'agit d\'un', avantage, pour, un, coureur, quand, il, se, trouve, au, sein, 'd\'un', peloton, '(pas', en,
    'tete)', ou, derriere, un, autre, 'coureur. Si', son, deplacement, lui, permet, de, se, retrouver, aussi, au, sein,
    'd\'un peloton,', derriere, ou, a, cote, 'd\'un', autre, 'coureur,', il, beneficie, 'd\'une', seconde,
    'supplementaire. Attention,', en, cas, de, 'descente,', le, coureur, beneficie, 'd\'un', supplement, de, 2, secondes,
    au, lieu, de, 1, 'seconde.']]).
...
regle_rep(sprint, 1,
    ...
    'banniere,', ils, beneficient, de, secondes, 'et/ou', de, points, de, 'bonification. Ils', se, calculent, a, la, fin,
    de, chaque, 'etape. Les', secondes, de, bonification, sont, retirees, du, temps, du, coureur, et, les, points, de, 
    bonification, sont, ajoutes, au, score, de, son, 'equipe.']]).

regle_rep(sprint, 2,
    [[quel, est, l, avantage, d, un, sprint]],
    [['Il', permet, a, un, ou, plusieurs, coureurs, de, beneficier, de, secondes, 'et/ou', de, points, de, 
    'bonification. Ils', se, calculent, a, la, fin, de, chaque, 'etape. Les', secondes, de, bonification, sont, retirees, 
    du, temps, du, coureur, et, les, points, de, bonification, sont, ajoutes, au, score, de, son, 'equipe.']]).
% ---------------------------------------------------------------- %
regle_rep(serie, 1,
    [[qu, est, ce, qu, une, chute, en, serie]],
    [['Il', est, interdit, de, rentrer, en, contact, avec, 'd\'autres', coureurs, dans, le, jeu, mais, parfois, un, 
    coureur, est, contraint, de, 's\'arreter', sur, une, case, ou, se, trouve, deja, un, 'coureur. Dans', ce, 'cas,', il, 
    provoque, automatiquement, une, chute, en, 'serie. Les', coureurs, concernes, doivent, se, defausser, 'd\'une', carte, 
    seconde, puis, passer, un, 'tour. Une', chute, en, serie, a, lieu, sur, toute, la, largeur, de, la, route, et, implique, 
    les, coureurs, 'suivants :', le, coureur, ayant, provoque, la, chute, en, 'serie; le', coureur, avec, lequel, il, rentre, 
    en, 'contact; tous', les, coureurs, situes, sur, les, cases, adjacentes, portant, le, meme, 'numero,', y, compris, 
    les, lettres, 'A, B, C etc.; tous', les, coureurs, 'qui,', lors, de, ce, tour, de, 'jeu,', ne, peuvent, pas, freiner, 
    a, temps, et, arrivent, sur, une, des, cases, affectees, par, 'l\'accident.']]).

regle_rep(serie, 2,
    [[qu, est, ce, qui, provoque, une, chute, en, serie]],
    [['Une', chute, en, serie, est, provoquee, par, le, contact, entre, 2, 'coureurs, c\'est-a-dire, qu\'ils s\'arretent', 
    sur, la, meme, 'case.']]).
...
regle_rep(serie, 4,
    ...
    les, placer, dans, 'l\'ordre', de, 'chute :', du, coureur, qui, a, provoque, la, chute, au, coureur, qui, a, rejoint, 
    plus, tard, le, lieu, de, 'l\'accident. Une', fois, que, tous, ces, coureurs, auront, passe, leur, 'tour,', ils, 
    repartiront, dans, cet, 'ordre.']]).
...
regle_rep(depasser, 1,
    ...
    [['Oui,', uniquement, si, toute, la, largueur, de, la, route, est, occupee, par, des, coureurs, et, que, le, coureur, 
    possede, assez, de, secondes, pour, passer, le, groupe, de, 'coureurs.']]).
% ---------------------------------------------------------------- %
